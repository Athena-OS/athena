...
* Environment variables for payload repositories: **$SECLISTS**, **$PAYLOADSALLTHETHINGS**, **$FUZZDB**, **$AUTOWORDLISTS**, **$SECURITYWORDLIST**, **$MIMIKATZ**, **$POWERSPLOIT**, **ROCKYOU**, **DIRSMALL**, **DIRMEDIUM**, **DIRBIG**, **WEBAPI**, **WEBCOMMON**, **WEBPARAM**
