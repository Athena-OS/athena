...
jQuery(function () {
    ...
    function expandCHildRow(icon, row, values) {
        if (row.child.isShown()) {
            ...
            // Open this row
            row.child(
                `<div class="proxy_child_row" style="width: 97vw; overflow: scroll;">
            ...
            "columns": [{
                render: function (data, type, row) {
                    ...
                    <div style="min-width:85px">
                        ...
                        <i class=" large icon globe request_details" data-position="bottom left" title="Send to R-Builder" ></i>
                        </div>
                        <div class="ui mini icon button">
                        <i class=" large icon bug rattacker" data-position="bottom left" title="Send to R-Attacker" ></i>
                        </div>
                    </div>`
                }
